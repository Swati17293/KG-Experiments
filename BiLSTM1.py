...
def train_save_model(dataset,model_name,maxlen,num_wrds):
    ...
    gate_model = LSTM(128, dropout=0.5, recurrent_dropout=0.2)(embed_title)
...
def main():
    ...
    if os.path.exists('models/BiLSTM13/') == False:
        os.mkdir('models/BiLSTM13/')
        train_save_model("KG3","BiLSTM13",12,3730)
        evaluate("KG3","BiLSTM13")
