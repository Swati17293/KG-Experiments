...
def train_save_model(dataset,model_name,summarylen,num_wrds):
    ...
    gate_model = Bidirectional(LSTM(128, dropout=0.5, recurrent_dropout=0.2))(embed_summary)
...
def main():
    ...
    if os.path.exists('models/BiLSTM23/') == False:
        os.mkdir('models/BiLSTM23/')
        train_save_model("KG3","BiLSTM23",31,1413)
        evaluate("KG3","BiLSTM23")
