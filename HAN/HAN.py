...
data_train = pd.read_csv('train.csv').fillna('na')
cols = ["nytimes", "indiatimes", "washingtonpost", "usatoday", "chinadaily"]
...
preds = Dense(5, activation='sigmoid')(words_att)
...
model.fit(x_train, y_train, validation_data=(x_val, y_val),
          epochs=1, batch_size=128,  callbacks=[RocAuc])
